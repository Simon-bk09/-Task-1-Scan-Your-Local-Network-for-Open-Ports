 ...
 * [Veryfing tool](#Veryfingtool)
 * [Finding Local ip range](#FindingLocaliprange)
 * [Running Nmap command](#RunningNmapcommand)
 * [Scan result and storing in txt format](#Scanresultandstoringintxtformat)
 * [Note Down IP Addresses and Open Ports](#NoteDownIPAddressesandOpenPorts)
 * [Analyze with Wireshark](#AnalyzewithWireshark)
 * [Research Common Services](#ResearchCommonServices)
 * [Potential Security Risks](#PotentialSecurityRisks)
